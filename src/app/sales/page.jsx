...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <RichTextEditor placeholder="Start typing your post..." onSave={savePost} onUpdate={updatePost} api={'/api/sales'} pageTitle={'Sales Section'} addAPI={'/api/sales/newSection'} />
    </div>
  );
}
