...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <RichTextEditor placeholder="Start typing your post..." onSave={savePost} onUpdate={updatePost} api={'/api/marketing'} pageTitle={'Marketing Section'} addAPI={'/api/marketing/newSection'} />
    </div>
  );
}
