    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-500 flex flex-col justify-center items-center text-white">
      ...
      >
        ...
        <motion.p
          ...
          transition={{ duration: 1 }}
        >
          Dive into our product development journey, from roadmap to testing.
        </motion.p>
        ...
        >
          ...
          >
            <h2 className="text-2xl font-semibold mb-4">Product Roadmap</h2>
            <p>See our planned milestones and timelines for the product.</p>
            <Link
          ...
          >
            ...
            <p>Understand the market dynamics to make data-driven decisions.</p>
            <Link
          ...
          >
            ...
            <p>Track the ongoing product development process.</p>
            <Link
              href="/product/development-status"
              className="mt-4 inline-block text-blue-500 hover:text-blue-700 transition"
            >
              Learn More &rarr;
            </Link>
          ...
          >
            ...
            <p>Ensure quality with comprehensive testing protocols.</p>
            <Link
