...
import { Code,  Beaker, Network, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Low-Code & AI-Powered Prototyping", 
    description: "Tools for rapid concept validation before full-scale development.", 
    details: [], 
    icon: <Code className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Proof-of-Concept (PoC) Testing", 
    description: "Repository for small-scale fintech experiment results.", 
    details: [], 
    icon: <Beaker className="h-8 w-8 text-purple-500" /> 
  },
  { 
    title: "DeFi Experimentation & Financial Infrastructure", 
    description: "Research into new-age financial mechanisms like AMMs and tokenized assets.", 
    details: [], 
