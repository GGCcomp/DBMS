...
import { BookOpen, Video, Users, Lightbulb, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Internal Research Wiki", 
    description: "Centralized repository for fintech white papers, research reports, and findings.", 
    details: [], 
    icon: <BookOpen className="h-8 w-8 text-yellow-500" /> 
  },
  { 
    title: "Live Research Seminars & Webinars", 
    description: "Platform for industry discussions and expert-led research presentations.", 
    details: [], 
    icon: <Video className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Cross-Team Collaboration", 
    description: "Integration with Slack, Microsoft Teams, or internal discussion boards.", 
    details: [], 
    icon: <Users className="h-8 w-8 text-purple-500" /> 
  },
  { 
    title: "Innovation Challenges & Hackathons", 
    description: "Repository for internal fintech problem-solving and ideation sessions.", 
    details: [], 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-500 p-8 flex flex-col items-center">
      ...
      <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} 
        ...
        Knowledge Sharing & Research Repository
      </motion.h1>
