...
import { LineChart, ShieldCheck, Server, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Market Data Aggregation", 
    description: "Repository of real-time financial data, behavioral analytics, and investment trends.", 
    details: [], 
    icon: <LineChart className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Regulatory Compliance & AML Research", 
    description: "Studies on fraud detection, anti-money laundering (AML) automation, and transaction monitoring.", 
    details: [], 
    icon: <ShieldCheck className="h-8 w-8 text-green-500" /> 
  },
  { 
    title: "Scalable Data Processing", 
    description: "Research on high-performance computing for financial datasets (Kafka, Hadoop, Spark).", 
    details: [], 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-500 p-8 flex flex-col items-center">
      ...
      <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} 
        ...
        Financial Data Analytics & Big Data Processing
      </motion.h1>
