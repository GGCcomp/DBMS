...
import { Wallet, Banknote, Fingerprint, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Smart Contracts & Decentralized Finance (DeFi)", 
    description: "Research on tokenization, automated lending, and cross-chain interoperability.", 
    details: [], 
    icon: <Wallet className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Central Bank Digital Currency (CBDC) & Stablecoins", 
    description: "Studies on digital asset issuance and regulatory frameworks.", 
    details: [], 
    icon: <Banknote className="h-8 w-8 text-green-500" /> 
  },
  { 
    title: "Digital Identity & KYC Innovations", 
    description: "AI-driven biometric authentication and fraud detection methods.", 
    details: [], 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-500 p-8 flex flex-col items-center">
      ...
      <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} 
        ...
        Blockchain & Digital Finance Research
      </motion.h1>
