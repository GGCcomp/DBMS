...
import { ShieldCheck, FileText, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Automated Compliance Tracking", 
    description: "Repository for fintech regulations, including PCI DSS, GDPR, Basel III, and SOC 2.", 
    details: [], 
    icon: <ShieldCheck className="h-8 w-8 text-green-500" /> 
  },
  { 
    title: "Regulatory Sandboxes", 
    description: "Space for testing new fintech solutions under controlled conditions.", 
    details: [], 
    icon: <FileText className="h-8 w-8 text-yellow-500" /> 
  },
  { 
    title: "Smart Legal Contracts", 
    description: "Blockchain-based automation of regulatory compliance for financial agreements.", 
    details: [], 
