...
import { BrainCircuit, Search, ShieldCheck, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Predictive Analytics & Risk Modeling", 
    description: "AI-driven credit risk analysis, fraud detection, and investment forecasting.", 
    details: [], 
    icon: <Search className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Natural Language Processing (NLP) for Finance", 
    description: "Research on AI-powered financial advisory and regulatory monitoring.", 
    details: [], 
    icon: <BrainCircuit className="h-8 w-8 text-green-500" /> 
  },
  { 
    title: "AI Fairness & Compliance", 
    description: "Studies on explainable AI (XAI), fair lending algorithms, and regulatory alignment.", 
    details: [], 
