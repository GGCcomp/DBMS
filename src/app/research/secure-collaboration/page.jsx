...
import { Cloud, FileText, X, Eye, Download } from "lucide-react";

const sectionsData = [
  { 
    title: "Jupyter Notebooks & Data Science Tools", 
    description: "Research repository supporting Python, R, MATLAB, and Julia for financial modeling.", 
    details: [], 
    icon: <Cloud className="h-8 w-8 text-yellow-500" /> 
  },
  { 
    title: "Cloud Compute Resources", 
    description: "Secure environment for AI model training and large-scale data analysis.", 
    details: [], 
    icon: <FileText className="h-8 w-8 text-blue-500" /> 
  },
  { 
    title: "Secure Multi-Party Computation (MPC)", 
    description: "Studies on secure fintech data-sharing without exposing sensitive information.", 
    details: [], 
