  ...
  try {
    ...
    const newEmployee = await Employee.create({
      ...
      profile: {
        ...
        bank: {
          name: formData.get("bank[name]"),
          accountNo: formData.get("bank[accountNo]"),
          IFSC: formData.get("bank[IFSC]"),
...
export async function DELETE(req) {
  ...
  const { id, filesToRemove = [] } = await req.json();

  // Remove employee record from DB
