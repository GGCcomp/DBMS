...
import { SoftwareNeeded } from "@/models/post";
...
export async function GET(request) {
  ...
  try {
    const posts = await SoftwareNeeded.find();
    ...
    const content = await SoftwareNeeded.aggregate(pipeline);
...
export async function POST(request) {
  ...
  try {
    ...
    const arrayFilters = [
      ...
      let result = await SoftwareNeeded.updateOne(
        updateQuery,
