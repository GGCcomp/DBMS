    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      >
        ...
        >
          ...
          <option value="unitIntegrationTesting">Unit Testing</option>
          <option value="regressionUAT">Regression UAT</option>
          <option value="securityTesting">Security Testing</option>
          <option value="loadStressTesting">Load Testing</option>
...
const Page = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const res = await fetch("/api/development/testing-quality"); 
