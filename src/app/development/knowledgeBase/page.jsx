    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      >
        ...
        >
          ...
          <option value="developmentGuidelines">Development Guidelines</option>
          <option value="documentationTrainingMaterials">Documentation Training Materials</option>
          <option value="troubleshootingReviewLogs">Trouble Shooting ReviewLogs</option>
          <option value="aiPerformanceOptimizationStrategies">AI Performance Optimization Strategies</option>
        </select>
...
const Page = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const res = await fetch("/api/development/knowledge-base"); 
    ...
    if (res.ok) {
      ...
      try {
        await fetch("/api/audit-log", {
          ...
          body: JSON.stringify({
            action: "Upload",
            details: "In Knowledge Base Devlopment"
          }),
        });
      } catch (error) {
                        ...
                        onClick={async (e) => {
                          try {
                            ...
                            await fetch("/api/audit-log", {
                              ...
                              body: JSON.stringify({
                                action: "Download",
                                details: "From Knowledge Base Devlopment",
                              }),
                            });
                          } catch (error) {
                            console.error("Failed to log audit:", error);
